...
Route::group(['prefix' => config('hc.admin_url'), 'middleware' => ['web', 'auth']], function ()
{
    ...
    Route::group(['prefix' => 'api/resources/thumbs'], function ()
    {
        ...
        Route::get('list', ['as' => 'admin.api.resources.thumbs.list', 'middleware' => ['acl:interactivesolutions_honeycomb_resources_resources_thumbs_list'], 'uses' => 'regions\\HCThumbsController@apiIndex']);
